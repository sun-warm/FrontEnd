  ...
  <div class="form-section">
    ...
    <form @submit.prevent="addAccount">
      ...
      <div class="form-group">
        ...
        <select v-model="newAccount.department">
      ...
      <div class="form-group">
        ...
        <select v-model="newAccount.role">
          ...
          <option value="adminstrator">管理</option>
        </select>
      </div>
        ...
        const response = await axios(
          {
            ...
            data: {
              ...
              user_name: this.newAccount.username,
              pass_word: this.newAccount.password,
              role: this.newAccount.role == "user" ? 1 : 2,
              department: this.newAccount.department
            },
